...
const Top funcTab[]={	
	...
	{"sumx", 8, 0, 0, F SUMXM, 0, ""},
	{"sumy", 8, 0, 0, F SUMYM, 0, ""},
	{"sumq", 8, 0, 0, F SUM2M, 2053, "Sum of squares"},
	{"sumxq", 8, 0, 0, F SUMX2M, 0, ""},
	{"sumyq", 8, 0, 0, F SUMY2M, 0, ""},
	{"sumxy", 8, 0, 0, F SUMXYM, 0, ""},
	{"geom", 8, 0, 0, F GEOMM, 2103, "Geometric mean, N-th root of product of N items"},
	{"harmon", 8, 0, 0, F HARMONM, 2104, "Harmonic meam"},
	...
	{"avex", 8, 0, 0, F AVEXM, 0, ""}, {"meanx", 8, 0, 0, F AVEXM, 0, NULL},
	{"avey", 8, 0, 0, F AVEYM, 0, ""}, {"meany", 8, 0, 0, F AVEYM, 0, NULL},
	{"aveq", 8, 0, 0, F AVE2M, 2063, "Mean of squares"}, {"meanq", 8, 0, 0, F AVE2M, 0, NULL},
	{"avexq", 8, 0, 0, F AVEX2M, 0, ""}, {"meanxq", 8, 0, 0, F AVEX2M, 0, NULL},
	{"aveyq", 8, 0, 0, F AVEY2M, 0, ""}, {"meanyq", 8, 0, 0, F AVEY2M,	0, NULL},
	{"vara", 8, 0, 0, F VAR0M, 2080, "Variance of population"},
	{"varxa", 8, 0, 0, F VARX0M, 0, ""},
	{"varya", 8, 0, 0, F VARY0M, 0, ""},
	{"var", 8, 0, 0, F VAR1M, 2055, "Variance"},
	{"varx", 8, 0, 0, F VARX1M, 0, ""},
	{"vary", 8, 0, 0, F VARY1M, 0, ""},
	{"stdeva", 8, 0, 0, F STDEV0M, 2049, "Standard deviation of population"},
	{"stdevxa", 8, 0, 0, F STDEVX0M, 0, ""},
	{"stdevya", 8, 0, 0, F STDEVY0M, 0, ""},
	{"stdev", 8, 0, 0, F STDEV1M, 2065, "Standard deviation"},
	{"stdevx", 8, 0, 0, F STDEVX1M, 0, ""},
	{"stdevy", 8, 0, 0, F STDEVY1M, 0, ""},
	{"lra", 8, 0, 0, F LRAM, 0, ""},
	{"lrb", 8, 0, 0, F LRBM, 0, ""},
	{"lrr", 8, 0, 0, F LRRM, 0, ""},
	{"lrx", CMDVARARG+2, 0, 0, F LRXM, 0, ""},
	{"lry", CMDVARARG+2, 0, 0, F LRYM, 0, ""},
	...
	{"integral", CMDFOR+5, 0, 0, F INTEGRALM, 0, ""},
	{"for", CMDFOR+4, 0, 0, 0, 0, ""},
	{"foreach", CMDFOR+3, 0, 0, 0, 0, ""},
	{"sumfor", CMDFOR+4, 0, 0, F PLUSM, 0, ""},
	{"sumforeach", CMDFOR+3, 0, 0, F PLUSM, 0, ""},
	{"productfor", CMDFOR+4, 0, F ONEC, F MULTM, 0, ""},
	{"productforeach", CMDFOR+3, 0, F ONEC, F MULTM,	0, ""},
	{"listfor", CMDFOR+4, 0, 0, F CONCATM, 0, ""},
	{"listforeach", CMDFOR+3, 0, 0, F CONCATM, 0, ""},
	{"rowsfor", CMDFOR+4, 0, 0, F CONCATROWM, 0, ""},
	{"rowsforeach", CMDFOR+3, 0, 0, F CONCATROWM, 0, ""},
	{"minfor", CMDFOR+4, 0, 0, F MIN3M, 0, ""},
	{"minforeach", CMDFOR+3, 0, 0, F MIN3M, 0, ""},
	{"maxfor", CMDFOR+4, 0, 0, F MAX3M, 0, ""},
	{"maxforeach", CMDFOR+3, 0, 0, F MAX3M, 0, ""},
	...
	{"nor", 199, F NORX, 0, 0, 0, ""},
	{"bitnor", 199, F NORBX, F NORBC, F NORBM, 0, ""},
	...
	{"nand", 197, F NANDX, 0, 0, 0, ""},
	{"bitnand", 197, F NANDBX, F NANDBC, F NANDBM, 0, ""},
	{"imp", 200, F IMPX, 0, 0, 0, ""}, {"->", 200, F IMPX, 0, 0, 0, NULL},
	{"bitimp", 200, F IMPBX, F IMPBC, F IMPBM, 0, ""},
	...
	{"atan", 8, F ATANX, F ATANC, 0,	2031, "inverse tangent"}, {"atg", 8, F ATANX, F ATANC, 0, 0, ""}, {"arctan", 8, F ATANX, F ATANC, 0, 0, NULL}, {"arctg", 8, F ATANX, F ATANC, 0, 0, NULL},
	{"acot", 8, F ACOTGX, F ACOTGC, 0,	2124, "inverse cotangent"}, {"acotg", 8, F ACOTGX, F ACOTGC, 0, 0, ""}, {"arccot", 8, F ACOTGX, F ACOTGC, 0, 0, NULL}, {"arccotg", 8, F ACOTGX, F ACOTGC, 0, 0, NULL},
	{"asec", 8, 0, F ASECC, 0, 2125, "inverse secant"},
	{"acsc", 8, 0, F ACSCC, 0, 2126, "inverse cosecant"},

	{"sinh", 8, F SINHX, F SINHC, 0, 0, ""},
	{"cosh", 8, F COSHX, F COSHC, 0, 0, ""},
	{"tanh", 8, F TANHX, F TANHC, 0, 0, ""}, {"tgh", 8, F TANHX, F TANHC, 0, 0, ""},
	{"coth", 8, F COTGHX, F COTGHC, 0, 0, ""}, {"cotgh", 8, F COTGHX, F COTGHC, 0, 0, ""},
	{"sech", 8, 0, F SECHC, 0, 0, ""},
	{"csch", 8, 0, F CSCHC, 0, 0, ""},
	{"asinh", 8, 0, F ASINHC, 0, 0, ""}, {"argsinh", 8, 0, F ASINHC, 0, 0, ""},
	{"acosh", 8, 0, F ACOSHC, 0, 0, ""}, {"argcosh", 8, 0, F ACOSHC, 0, 0, ""},
	{"atanh", 8, 0, F ATANHC, 0, 0, ""}, {"atgh", 8, 0, F ATANHC, 0, 0, ""}, {"argtanh", 8, 0, F ATANHC, 0, 0, ""}, {"argtgh", 8, 0, F ATANHC, 0, 0, ""},
	{"acoth", 8, 0, F ACOTGHC, 0, 0, ""}, {"acotgh", 8, 0, F ACOTGHC, 0, 0, ""}, {"argcoth", 8, 0, F ACOTGHC, 0, 0, ""}, {"argcotgh", 8, 0, F ACOTGHC, 0, 0, ""},
	{"asech", 8, 0, F ASECHC, 0, 0, ""},
	{"acsch", 8, 0, F ACSCHC, 0, 0, ""},

	{"radtodeg", 8, F RADTODEGX, 0, 0, 0, ""},
	{"degtorad", 8, F DEGTORADX, 0, 0, 0, ""},
	{"radtograd", 8, F RADTOGRADX, 0, 0, 0, ""},
	{"gradtorad", 8, F GRADTORADX, 0, 0, 0, ""},
	{"degtograd", 8, F DEGTOGRADX, 0, 0, 0, ""},
	{"gradtodeg", 8, F GRADTODEGX, 0, 0, 0, ""},
	{"deg", 8, F DEGX, 0, 0, 0, ""},
	{"rad", 8, F RADX, 0, 0, 0, ""},
	{"grad", 8, F GRADX, 0, 0, 0, ""},
	{"todeg", 8, F TODEGX, 0, 0, 0, ""},
	{"torad", 8, F TORADX, 0, 0, 0, ""},
	{"tograd", 8, F TOGRADX, 0, 0, 0, ""},
	{"dms", 8, F DMSTODECX, 0, 0, 2025, "Degrees, minutes, seconds => degrees"},
	{"todms", 8, F DECTODMSX, 0, 0, 0, ""},
	{"ftoc", 8, F FTOCX, 0, 0, 0, ""},
	{"ctof", 8, F CTOFX, 0, 0, 0, ""},

	//matrix operators
	{"transp", 9, 0, 0, F TRANSPM, 0, ""},
	{"invert", 8, 0, 0, F INVERTM, 0, ""},
	{"elim", 9, 0, 0, F ELIMM, 0, ""},
	{"solve", 9, 0, 0, F EQUSOLVEM, 0, ""},
	{"angle", CMDVARARG+2, 0, 0, F ANGLEM, 0, ""},
	{"vert", 120, 0, 0, F VERTM, 0, ""},
	{"width", 9, 0, 0, F WIDTHM, 0, ""},
	{"height", 9, 0, 0, F HEIGHTM, 0, ""},
	{"det", 8, 0, 0, F DETM, 0, ""},
	{"rank", 8, 0, 0, F RANKM, 0, ""},
	{"polynom", CMDVARARG+2, 0, 0, F POLYNOMM, 0, ""},
	{"matrix", CMDVARARG+2, 0, 0, F MATRIXM, 0, ""},
	{"swap", CMDVARARG+2, 0, 0, F SWAPM, 0, ""},
};
